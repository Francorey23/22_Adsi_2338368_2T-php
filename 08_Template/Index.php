<?php 
    require_once("plantilla/plantillaIndex.php");
?>
      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li>
              <a href="#" class="nav-link text-white">
              <i class="bi bi-bag-fill"><use xlink:href="#table"></use></i><font _mstmutation="1" _msthash="2066272" _msttexthash="106808"> Órdenes </font></a>
            </li>
            <li>
              <a href="#" class="nav-link text-white">
              <i class="bi bi-apple"><use xlink:href="#grid"></use></i><font _mstmutation="1" _msthash="2066454" _msttexthash="139529"> Productos </font></a>
            </li>
            <li>
              <a href="#" class="nav-link text-white">
              <i class="bi bi-person-circle"><use xlink:href="#people-circle"></use></i><font _mstmutation="1" _msthash="2066636" _msttexthash="132210"> Clientela </font></a>
            </li>
          </ul>
        </div>
      </div>
